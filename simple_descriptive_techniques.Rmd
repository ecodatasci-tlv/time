...
clues for possible underlying processes in lags 2-4 and 12-16

the PACF can be thought of as analogous to a second derivative
***

Summary till now, using just Correlograms for the entire series
* cycle length - about 19
* Lags 2-4, 12-16 are suspected
...
we get a strong correlation between total, deaths, and emerging. but is this causative ?
...
```
Reminder: Lags 2-4, 12-16 are suspected from total
eggs
non emerging - 
emerging - positive at 2-4 weeks !
