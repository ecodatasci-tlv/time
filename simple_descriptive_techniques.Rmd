...
* Study the most basic R tools for exploration
 + No packages other than the pre-installed ones
* Understand the concept of serial correlation in time
...
we could always plotting the dataframe variables against each other
 ...
 * Most of the methodology of time series covers only discrete time and continuous (or pseudo) variable
